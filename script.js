$(document).ready(function() {
  ...
  var apiRoot = 'https://kodilla-exercise.herokuapp.com/v1/tasks';
...
//    var taskTitle = $(this).find('[data-newtask-name-input]').val();
//    var taskContent = $(this).find('[data-newtask-content-input]').val();
